(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('lodash.template'), require('lodash.templatesettings'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/router', 'lodash.template', 'lodash.templatesettings', '@angular/common'], factory) :
	(factory((global['ngx-breadcrumbs'] = {}),global.ng.core,global.ng.router,global.lodash.template,global.lodash.templatesettings,global.ng.common));
}(this, (function (exports,core,router,template,templateSettings,common) { 'use strict';
...
var McBreadcrumbsService = /** @class */ (function () {
    ...
    function McBreadcrumbsService(_router, route, _config, _injector) {
        ...
        this._router.events
            .pipe(filter(function (x) { return x instanceof router.NavigationEnd; }))
            .subscribe(function (event) {
            var currentRoot = _router.routerState.snapshot.root;
            // Observable.of(this._config.prefixCrumbs)
            _this._resolveCrumbs(currentRoot).pipe(mergeMap(function (x) { return x; }), distinct(function (x) { return x.text; }), toArray(), mergeMap(function (x) {
    ...
    McBreadcrumbsService.prototype._resolveCrumbs = function (route) {
        ...
        if (route.firstChild) {
            crumbs$ = crumbs$.pipe(concat$1(this._resolveCrumbs(route.firstChild)));
        }
        return crumbs$;
    };
